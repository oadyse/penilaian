                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- @if ($soal)
                                <div></div>
                            @else --}}
                            <a href="{{ route('form-soal') }}" class="btn btn-primary rounded-pill">
                                Add New
                            </a>
                            {{-- @endif --}}
                        </div>
                                ...
                                <table id="datatable-1" class="table data-table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $soal) {
                                            ...
                                            if ($soal->status == 1) {
                                                $status = "Aktif";
                                            } else if ($soal->status == 0){
                                                $status = "Expired";
                                            } else if (empty($soal->status)) {
                                                $status = "";
                                            }
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="iq-icons-list m-0 text-left"
                                                    href="{{ route('preview-soal', base64_encode($id)) }}"
                                                    title="Preview Soal">
                                                ...
                                                <a class="iq-icons-list m-0 text-warning"
                                                    href="{{ route('edit-soal', base64_encode($id)) }}" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="m-0">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <a class="iq-icons-list m-0 text-danger"
                                                    href="{{ route('delete-soal', base64_encode($id)) }}"
                                                    title="Delete">
