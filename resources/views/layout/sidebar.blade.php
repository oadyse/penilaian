        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                ...
                <li class="px-3 pt-3 pb-2">
                    <span class="text-uppercase small font-weight-bold">Penilaian</span>
                </li>

                @if (Auth::user()->role == 'admin' || Auth::user()->role == 'guru')
                    <li class="{{ Request::is('data-penilaian') ? 'active' : '' }} sidebar-layout">
                        <a href="{{ route('index-penilaian') }}" class="svg-icon">
                            <i class="">
                            ...
                            <span class="ml-2">Data Penilaian</span>
                        </a>
                    </li>
                @endif

                {{-- @if (Auth::user()->role == 'guru')
                    <li class="{{ Request::is('hal-soal') ? 'active' : '' }} sidebar-layout">
                        <a href="{{ route('index-soal') }}" class="svg-icon">
                            <i class="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="ml-2">Input Nilai</span>
                        </a>
                    </li>
                @endif --}}

                @if (Auth::user()->role == 'siswa')
                    <li class="{{ Request::is('hasil-siswa') ? 'active' : '' }} sidebar-layout">
                        <a href="{{ route('hasil-siswa') }}" class="svg-icon">
                            <i class="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="ml-2">Kartu Hasil Siswa</span>
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->role == 'admin')
                    ...
                    <li class="{{ Request::is('data-user') ? 'active' : '' }} sidebar-layout">
                        <a href="{{ route('index-user') }}" class="svg-icon">
                            <i class="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
